 ...
 */
internal class NetworkRefactorV2Router @Inject constructor() : Router() {
	...
	@Binds
	@IntoSet
	fun bind(impl: NetworkRefactorV2Router): Router
    }
	...
	fm.commit {
	    replace(layoutId, NetworkV2Fragment())
	    addToBackStack("NetworkV2Fragment")
	}
