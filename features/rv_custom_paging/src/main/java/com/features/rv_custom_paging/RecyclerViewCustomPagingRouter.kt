 ...
 */
internal class RecyclerViewCustomPagingRouter @Inject constructor() : Router() {
	...
	@Binds
	@IntoSet
	fun bind(impl: RecyclerViewCustomPagingRouter): Router
    }
	...
	fm.commit {
	    ...
	    addToBackStack("CustomPagingFragment")
	}
